defmodule DarianCalendar do
  ...
  @unix_epoch 2_440_587.5
  # Midnight 11th March 1609
  @telescopic_epoch 2_308_804.50000
  # Midnight 29th December 1873
  @allison_epoch 2_405_522.0028779
  # Chose the Starting Epoch for March Calendar
  @epoch_offset @telescopic_epoch
  ...
  def to_string(d_date, name_type \\ :defrost) do
    ...
    "#{sol_name} #{d_date.sol} #{month_name} #{d_date.year} @ #{d_date.hour}:#{d_date.min}:#{
      d_date.sec
    }"
  end
end
